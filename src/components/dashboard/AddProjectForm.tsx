  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-3 items-end">
      ...
      <button
        ...
        className="px-6 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 disabled:opacity-70 disabled:border disabled:border-gray-500 disabled:cursor-not-allowed transition-colors"
      >
